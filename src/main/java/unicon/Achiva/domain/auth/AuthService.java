...
public class AuthService {
    ...
    public CreateMemberResponse signup(MemberRequest requestDto) {
        ...
        Member member = Member.builder()
                ...
                .email(email)
                .nickName(nickName)
                .profileImageUrl(requestDto.getProfileImageUrl() != null ? requestDto.getProfileImageUrl() : "https://achiva-bucket.s3.ap-northeast-2.amazonaws.com/default-profile-image.png")
